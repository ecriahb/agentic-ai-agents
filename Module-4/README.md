...
| 02 | [What Are Embeddings?](Lesson-02-What-Are-Embeddings.md) | Meaning ko numeric representation se understand karna |
| 03 | [How Text Becomes Vectors](Lesson-03-Text-to-Vectors.md) | Embedding pipeline ka mental model |
| 04 | [Similarity Search Basics](Lesson-04-Similarity-Search-Basics.md) | Query ke nearest semantic matches find karna |
| 05 | [Cosine Similarity & Distance](Lesson-05-Cosine-Similarity-and-Distance.md) | Similarity score ka intuition |
| 06 | [Vector Database Fundamentals](Lesson-06-Vector-Database-Fundamentals.md) | Store, index, search, metadata |
| 07 | [ChromaDB / FAISS Basics](Lesson-07-ChromaDB-and-FAISS-Basics.md) | Two practical vector-search approaches |
